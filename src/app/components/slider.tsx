...
export default function TeacherSlider() {
  ...
  return (
    ...
    <div className=" sm:py-10 py-4 sm:px-5 px-3 relative">
      <h2 className="text-[40px] font-[ppr-m] font-[700] text-[#1A237E] px-4 mb-5">Meet our teachers</h2>

      <div className="absolute top-1/2 left-0 z-10 flex gap-2 -translate-y-1/2">
        <div className="swiper-button-prev bg-white border px-4 py-2 p-2 rounded-full shadow-md"></div>
        <div className="swiper-button-next bg-white p-2 px-4 py-2 rounded-full shadow-md"></div>
      </div>
            ...
            <div className="bg-white overflow-hidden transition-all duration-300">
              <div className="relative">
                <Image
                  ...
                  width={500}
                  height={300}
                  className="rounded-tl-2xl px-4"
                />
              </div>
              <div className="p-4 text-center px-4 w-[480px] shadow-md">
